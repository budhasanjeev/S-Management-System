                ...
                <fieldset>
                    <legend>General Info</legend>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="grandFatherName" id="grandFatherName" onchange="validateGrandFatherName()">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="city" id="city" onchange="validateCity()">
                            <span hidden="true" class="error-city">please enter city name</span>
                        </div>
                        <div class="form-group">
                            <label for="zone">Zone:<span style="color:red">*</span></label>

                            <select name="zone" id="zone" class="form-control" onchange="printDistrict(this.value)">
                ...
                <fieldset>
                    <legend>Share</legend>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="numberOfShares" id="numberOfShares" onchange="form()">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="shareStart" id="shareStart" onchange="getShareValue()">
                    ...
                    <div class="form-group">
                        <label class="control-label ">Share Certificate no.:</label>
                            <input class="form-control" type="text" name="shareCertificateNumber" id="certificateNum" onchange="validateCertificateNum()">
                ...
                <fieldset>
                    <legend>Citizenship</legend>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="citizenshipNo" id="citizenshipNo" onchange="checkCitizenship()">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="citizenshipIssueDistrict" id="citizenshipIssueDistrict" onchange="isssuedDistrict()">
